...
BonusData.BonusPassives = {
	["PAS-001"] = { name = "Brutal", bpCost = 100, minRarity = "Uncommon", eligible = "HighDamageMelee", slotCost = 1 },
	["PAS-002"] = { name = "Stagger", bpCost = 100, minRarity = "Uncommon", eligible = "FastWeapons", slotCost = 1 },
	["PAS-003"] = { name = "Knockback", bpCost = 150, minRarity = "Rare", eligible = "BluntHeavy", slotCost = 1 },
	["PAS-004"] = { name = "Armor Pierce", bpCost = 130, minRarity = "Rare", eligible = "Piercing", slotCost = 1 },
	["PAS-005"] = { name = "Fortify", bpCost = 120, minRarity = "Rare", eligible = "NonSingleTarget", slotCost = 1 },
	["PAS-006"] = { name = "Arcane Flow", bpCost = 80, minRarity = "Uncommon", eligible = "Magical", slotCost = 1 },
	["PAS-007"] = { name = "Range +1", bpCost = 190, minRarity = "Epic", eligible = "ApprovedRanged", slotCost = 1 },
	["PAS-008"] = { name = "Arcane Reach", bpCost = 120, minRarity = "Rare", eligible = "ApprovedRanged", slotCost = 1 },
	["PAS-009"] = { name = "Surveyor Visor Range", bpCost = 70, minRarity = "Uncommon", eligible = "Any", slotCost = 1 },
	["PAS-010"] = { name = "Long-Throw Strap Range", bpCost = 80, minRarity = "Uncommon", eligible = "Any", slotCost = 1 },
	["PAS-011"] = { name = "Movement Range +1", bpCost = 150, minRarity = "Rare", eligible = "Any", slotCost = 1 },
	["PAS-012"] = { name = "Jump +1", bpCost = 100, minRarity = "Uncommon", eligible = "Any", slotCost = 1 },
	["PAS-013"] = { name = "Force +1", bpCost = 150, minRarity = "Rare", eligible = "Any", slotCost = 1 },
	["PAS-014"] = { name = "Stability +1", bpCost = 120, minRarity = "Rare", eligible = "Any", slotCost = 1 },
	["PAS-015"] = { name = "Discovery Radius +1", bpCost = 70, minRarity = "Uncommon", eligible = "Any", slotCost = 1 },
	["PAS-016"] = { name = "Fire Transformation", bpCost = 150, minRarity = "Rare", eligible = "NonElementalWeapons", slotCost = 1 },
	["PAS-017"] = { name = "Water Transformation", bpCost = 150, minRarity = "Rare", eligible = "NonElementalWeapons", slotCost = 1 },
	["PAS-018"] = { name = "Ice Transformation", bpCost = 150, minRarity = "Rare", eligible = "NonElementalWeapons", slotCost = 1 },
	["PAS-019"] = { name = "Electric Transformation", bpCost = 150, minRarity = "Rare", eligible = "NonElementalWeapons", slotCost = 1 },
	["PAS-020"] = { name = "Dark Transformation", bpCost = 170, minRarity = "Epic", eligible = "NonElementalWeapons", slotCost = 1 },
	["PAS-021"] = { name = "Holy Transformation", bpCost = 170, minRarity = "Epic", eligible = "NonElementalWeapons", slotCost = 1 },
	["PAS-022"] = { name = "Poison Transformation", bpCost = 170, minRarity = "Epic", eligible = "NonElementalWeapons", slotCost = 1 },
	["PAS-023"] = { name = "Cleave Conversion", bpCost = 200, minRarity = "Epic", eligible = "SingleTargetMelee", slotCost = 1 },
	["PAS-024"] = { name = "Line 2 Conversion", bpCost = 200, minRarity = "Epic", eligible = "SingleTargetThrust", slotCost = 1 },
	["PAS-025"] = { name = "Impact Splash Conversion", bpCost = 200, minRarity = "Epic", eligible = "SingleTargetRanged", slotCost = 1 },
	["PAS-026"] = { name = "Electric Ward", bpCost = 150, minRarity = "Rare", eligible = "ArmorShield", slotCost = 1 },
	["PAS-027"] = { name = "Electric Negation", bpCost = 250, minRarity = "Legendary", eligible = "ArmorShield", slotCost = 1 },
	["PAS-028"] = { name = "Electric Absorption", bpCost = 300, minRarity = "Mythic", eligible = "ArmorShield", slotCost = 1 },
	["PAS-029"] = { name = "Fire Ward", bpCost = 150, minRarity = "Rare", eligible = "ArmorShield", slotCost = 1 },
	["PAS-030"] = { name = "Water Ward", bpCost = 150, minRarity = "Rare", eligible = "ArmorShield", slotCost = 1 },
	["PAS-031"] = { name = "Ice Ward", bpCost = 150, minRarity = "Rare", eligible = "ArmorShield", slotCost = 1 },
	["PAS-032"] = { name = "Dark Ward", bpCost = 170, minRarity = "Epic", eligible = "ArmorShield", slotCost = 1 },
	["PAS-033"] = { name = "Holy Ward", bpCost = 170, minRarity = "Epic", eligible = "ArmorShield", slotCost = 1 },
	["PAS-034"] = { name = "Quickdraw Pouch", bpCost = 90, minRarity = "Uncommon", eligible = "Accessories", slotCost = 1 },
	["PAS-035"] = { name = "Guard Bonus +15%", bpCost = 120, minRarity = "Rare", eligible = "ShieldsArmor", slotCost = 1 },
	["PAS-036"] = { name = "Push RT x0.75", bpCost = 60, minRarity = "Uncommon", eligible = "Gloves", slotCost = 1 },
}
